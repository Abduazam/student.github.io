...
badge1.addEventListener("click", function () {
    sear_ish.style.display = "block";
    badge1.classList.add("active_badge1");
    let active_badge1 = document.querySelector(".active_badge1")
    active_badge1.addEventListener("click", function () {
        sear_ish.style.display = "none";
        badge1.classList.remove("active_badge1");
        
    });
});
btn_yonalish.addEventListener("click", function () {
    sear_toplam.style.display = "flex";
    btn_yonalish.classList.add("active_yonalish");
    let active_yonalish = document.querySelector(".active_yonalish")
    active_yonalish.addEventListener("click", function () {
        sear_toplam.style.display = "none";
        badge1.classList.remove("active_yonalish");
        
    });
});
header_badge2.addEventListener("click", function () {
    search.style.display = "block";
    header_badge2.classList.add("active_badge2");
    let active_badge2 = document.querySelector(".active_badge2")
    active_badge2.addEventListener("click", function () {
        search.style.display = "none";
        header_badge2.classList.remove("active_badge2");
